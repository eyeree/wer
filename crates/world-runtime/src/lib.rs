...
pub use generate::{
    ...
    RegionCache, RegionTiles, TerrainPossibilityHalo, TileBuffers, CHANNEL_CANOPY, CHANNEL_COUNT,
    CHANNEL_DIVERSITY, CHANNEL_ELEVATION, CHANNEL_FERTILITY, CHANNEL_HARDNESS, CHANNEL_HERBIVORE,
    CHANNEL_MOISTURE, CHANNEL_PREDATOR, CHANNEL_RIVER, CHANNEL_SLOPE, CHANNEL_SOIL_DEPTH,
