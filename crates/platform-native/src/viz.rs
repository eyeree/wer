...
// Milestone 1 moves value ownership without moving composition behavior yet.
// Keep the native module paths stable while callers migrate to `viewer_host`.
pub use viewer_host::map::{Channel, MapDecor, Overlays};
